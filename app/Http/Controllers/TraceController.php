...
//            $modelInfo->text_1 = base64_encode(file_get_contents(public_path('images/trace/'.$code.'.png'))); // address
            if($trace->info()->save($modelInfo)){
                ...
                $details = [
                    ...
                    'body' => '<p>Please present this CODE upon receiving your package.</p><br>
<table>
<thead>
<tr><th colspan="4" align="center">Dispatch Information</th></tr>
</thead>
<tbody>
<tr>
<td width="150" align="left">Driver Name</td>
