                        ...
                        <div class="ibox-content">
                            ...
                            @if($order->status->status == 'approved')
                                <form action="{{route('market-place.deliver')}}" method="post"
                                    ...
                                    @csrf
                                    <input type="hidden" value="{{$order->id}}" name="id">
                                    <button class="btn btn-primary float-right"><i class="fa fa fa-truck"></i> Deliver
                                    </button>
                                </form>
                            @endif
                            @if($order->status->status == 'delivery')
                                <form action="{{route('market-place.delivered')}}" method="post"
                                    ...
                                    @csrf
                                    <input type="hidden" value="{{$order->id}}" name="id">
                                    <button class="btn btn-primary float-right"><i class="fa fa fa-home"></i> Delivered
                                    </button>
                                </form>
                            @endif
                            {{--                            @if(!array_key_exists('approved', getMarketplaceOrderStatuses($order->id)))--}}
                            {{--                                <form action="{{route('market-place.approve')}}" method="post" enctype="multipart/form-data">--}}
                            {{--                                    @csrf--}}
                            {{--                                    <input type="hidden" value="{{$order->id}}" name="id">--}}
                            {{--                                    <button class="btn btn-primary float-right"><i class="fa fa fa-thumbs-up"></i> Approve</button>--}}
                            {{--                                </form>--}}
                            {{--                            @endif--}}
                            <div class="">
